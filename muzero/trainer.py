...
class Trainer:
    ...
    def update_weights(self, batch):
        ...
        loss.backward()
        #my addition clipping gradient norm
        torch.nn.utils.clip_grad_norm_(self.model.parameters(), 1.0, norm_type=2.0)
        #will try clipping value too, for experimental reasons
        # torch.nn.utils.clip_grad_value_(self.model.parameters(), 0.5)
        #also try this https://stackoverflow.com/questions/54716377/how-to-do-gradient-clipping-in-pytorch
